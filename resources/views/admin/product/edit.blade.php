<x-admin-layout>
    ...
    <x-molecule.container>
        ...
        <x-molecule.form action="{{ route('admin.product.update', $product) }}" enctype="multipart/form-data">
            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.input disabled="disabled" id="slug" type="text" class="mt-1 block w-full" value="{{ $product->slug }}" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.input id="name" type="text" name="name" class="mt-1 block w-full" value="{{ $product->name }}" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.select id="product_category_id" name="product_category_id" value="{{ $product->product_category_id }}" :allowEmpty="true" :options="$productCategories->pluck('name', 'id')" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.input id="points" type="number" name="points" class="mt-1 block w-full" value="{{ $product->points }}" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.input id="code" type="text" name="code" class="mt-1 block w-full" value="{{ $product->code }}" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.input id="uuid" type="text" name="uuid" class="mt-1 block w-full" value="{{ $product->uuid }}" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.textarea id="description" rows="5" name="description" class="mt-1 block w-full" value="{!! $product->description !!}" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    @if ($product->filename)
                    <img class="mt-4" src="{{ asset('storage/products/'.$product->filename) }}" alt="{{ $product->filename }}" />
                    @endif
                </div>
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.select id="is_published" name="is_published" value="{{ $product->is_published }}" :options="['0'=> 'Not Published', '1' => 'Published']" />
