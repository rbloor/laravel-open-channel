<x-admin-layout>
    ...
    <x-molecule.container>
        ...
        <x-molecule.heading>
            {{ __('Create Product Offer') }}
        </x-molecule.heading>

        <x-molecule.form action="{{ route('admin.product_offer.store') }}">
            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.select id="product_id" name="product_id" value="{{ old('product_id') }}" :allowEmpty="true" :options="$products->pluck('name', 'id')" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.input id="multiplier" type="number" name="multiplier" class="mt-1 block w-full" value="{{ old('multiplier') }}" />
