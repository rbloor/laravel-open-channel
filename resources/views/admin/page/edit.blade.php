<x-admin-layout>
    ...
    <x-molecule.container>
        ...
        <x-molecule.form action="{{ route('admin.page.update', $page) }}" enctype="multipart/form-data">
            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.input disabled="disabled" id="slug" type="text" class="mt-1 block w-full" value="{{ $page->slug }}" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.input id="name" type="text" name="name" class="mt-1 block w-full" value="{{ $page->name }}" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    @if ($page->filename)
                    <img class="mt-4" src="{{ asset('storage/pages/'.$page->filename) }}" alt="{{ $page->filename }}" />
                    @endif
                </div>
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.input id="banner_title" type="text" name="banner_title" class="mt-1 block w-full" value="{{ $page->banner_title }}" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.input id="banner_subtitle" type="text" name="banner_subtitle" class="mt-1 block w-full" value="{{ $page->banner_subtitle }}" />
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <x-atom.input id="banner_paragraph" type="text" name="banner_paragraph" class="mt-1 block w-full" value="{{ $page->banner_paragraph }}" />
