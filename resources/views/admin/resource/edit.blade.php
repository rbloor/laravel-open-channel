<x-admin-layout>
    ...
    <x-molecule.container>
        ...
        <div x-data="{ isExternal: {{ $resource->is_external }} }">

            <x-molecule.form action="{{ route('admin.resource.update', $resource) }}" enctype="multipart/form-data">
                ...
                <x-slot name="form">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-atom.input id="name" type="text" name="name" class="mt-1 block w-full" value="{{ $resource->name }}" />
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-atom.textarea id="description" rows="5" name="description" class="mt-1 block w-full" value="{{ $resource->description }}" />
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <img class="mt-4" src="{{ asset('storage/resources/'.$resource->filename) }}" alt="{{ $resource->filename }}" />
                        @endif
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-atom.select id="is_external" name="is_external" x-on:change="isExternal = $event.target.value" value="{{ $resource->is_external }}" :options="['0'=> 'No', '1' => 'Yes']" />
                    ...
                    <div x-show="isExternal == 0" class="col-span-6 sm:col-span-4">
                        ...
                        <img class="mt-4" src="{{ asset('storage/resources/'.$resource->download) }}" alt="{{ $resource->download }}" />
                        @endif
                    </div>
                    ...
                    <div x-show="isExternal == 1" class="col-span-6 sm:col-span-4">
                        ...
                        <x-atom.input id="url" type="text" name="url" class="mt-1 block w-full" value="{{ $resource->url }}" />
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <x-atom.select id="is_published" name="is_published" value="{{ $resource->is_published }}" :options="['0'=> 'Not Published', '1' => 'Published']" />
